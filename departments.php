...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
	<thead>
		<tr>
			...
			<th style="text-align:center;width:100px;">Add Department <button type="button"  class="btn btn-success btn-xs" data-toggle="modal" data-target="#addModal">
	...
	<?php   
			...
			while($row = $result->fetch_assoc()) {
				...
				<div class="next">
					<form method="post" action="updatedepartment.php" class="inline">
					<input type="hidden" name="deptid" value="'.$row["DEPT_ID"].'">
    ...
    <div class="modal-dialog modal-lg">
      ...
      <form method="post" action="updatedepartment.php">
        <div class='form-row'>
                <div class="col">
                    <label class="form-label">Department ID</label>
                    <input type="text" id="deptid" class="form-control" name="deptid" readonly>
                </div>
                <div class="col">
                    <label class="form-label">Department Name</label>
